...
-- PASSO 1: Adicionar coluna cliente_id na tabela relatorios
...
BEGIN
  ...
  FOR relatorio IN 
    SELECT id, cliente FROM public.relatorios 
...
-- 1. Tornar cliente_id obrigatório: ALTER TABLE relatorios ALTER COLUMN cliente_id SET NOT NULL;
-- 2. Remover coluna antiga 'cliente': ALTER TABLE relatorios DROP COLUMN cliente;
-- 
...
-- SELECT id, cliente, cliente_id FROM public.relatorios WHERE cliente_id IS NULL;
