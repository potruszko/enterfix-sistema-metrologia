 ...
 * 
 * Gerenciamento completo do ciclo de vida de instrumentos de medição.
...
1.1. A gestão de parque de instrumentos compreende:
    a) Cadastramento completo de todos os instrumentos;
    b) Planejamento e controle de calibrações periódicas;
    c) Gestão de manutenções preventivas e corretivas;
    d) Rastreabilidade de certificados e documentação;
    e) Controle de locais, responsáveis e status operacional;
    f) Alertas automáticos de vencimentos;
    g) Relatórios gerenciais e indicadores de desempenho;
    h) Gestão de não conformidades e ações corretivas.

1.2. Instrumentos abrangidos:
...
1.3. Modalidades de gestão:
    a) COMPLETA: Gestão total com software dedicado e suporte presencial;
    b) CONSULTIVA: Orientações e suporte com controle pela CONTRATANTE;
